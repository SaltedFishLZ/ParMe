...
def load_graphs() -> Dict[str, nx.Graph]:
    ...
    graphs['mini'], _ = EleNetX.cpu.get_xbar_cpu(n_cores=2,
                                              n_caches=2,
                                              n_ddrs=1,
                                              n_ios=1)
                                              
    graphs['desktop:0'], _ = EleNetX.cpu.get_ring_cpu(n_cores=4,
                                               n_ddrs=2,
                                               n_ios=2)

    graphs['desktop:1'], _ = EleNetX.cpu.get_ring_cpu(n_cores=8,
                                               n_ddrs=2,
                                               n_ios=2)
    
    graphs['server:0'], _ = EleNetX.cpu.get_mesh_cpu(n_cores_x=4, n_cores_y=4,
                                                  n_ddrs=4, n_ios=4)
